<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionEntry.ascx.cs" Inherits="RockWeb.Plugins.org_hbcfw.Finance.TransactionEntry" %>
                            ...
                            <div class="panel panel-default contribution-info">
                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        ...
                                        <Rock:RockTextBox ID="txtCommentEntry" runat="server" Required="false" Label="Comment" Placeholder="If Other, please specify here." />
